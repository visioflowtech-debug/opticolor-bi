...
export const metadata: Metadata = {
  title: 'Eficiencia de Órdenes | Opticolor BI',
};

export default function EficienciaOrdenesPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">📦 Eficiencia de Órdenes</h1>
        <p className="text-foreground/60 mt-2">
          Seguimiento de órdenes, plazos de entrega y cumplimiento
        </p>
      </div>
