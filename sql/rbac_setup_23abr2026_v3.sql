-- ============================================================================
-- RBAC SETUP V3 — OPTICOLOR BI VENEZUELA (IDEMPOTENTE)
-- Fecha: 23 Abril 2026 | Semana 3
-- Descripción: Configuración completa de roles, usuarios y RLS
-- Versión 3: Limpieza correcta respetando orden de FKs
-- ============================================================================
...
-- ============================================================================
-- FASE 0: LIMPIAR EN ORDEN INVERSO DE DEPENDENCIAS
-- ============================================================================
PRINT '=== FASE 0: Limpieza de dependencias ===';

-- Limpiar Seguridad_Usuarios_Sucursales (depende de Seguridad_Usuarios y Param_Sucursales_Directorio)
DELETE FROM Seguridad_Usuarios_Sucursales WHERE id_usuario > 1;

-- Limpiar Seguridad_Usuarios_Roles (depende de Seguridad_Usuarios y Seguridad_Roles)
DELETE FROM Seguridad_Usuarios_Roles WHERE id_usuario > 1;

-- Limpiar Seguridad_Usuarios (excepto SUPER_ADMIN id=1)
DELETE FROM Seguridad_Usuarios WHERE id_usuario > 1;

-- Limpiar Param_Sucursales_Directorio (ahora sin FKs activas)
DELETE FROM Param_Sucursales_Directorio;
...
-- ============================================================================
-- 1.3 CREAR O LIMPIAR TABLA: Param_Sucursales_Directorio
-- ============================================================================
...
ELSE
BEGIN
    PRINT 'Tabla Param_Sucursales_Directorio ya existe ✓';
END;
GO
...
(10, 9, GETUTCDATE(), 1),    -- BARBARA BOLIVAR → sucursal 9
...
PRINT '';
PRINT '✓ SCRIPT RBAC SETUP V3 COMPLETADO EXITOSAMENTE';
