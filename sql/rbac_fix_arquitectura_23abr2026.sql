-- ============================================================================
-- RBAC FIX — ARQUITECTURA CORREGIDA
...
PRINT '╔════════════════════════════════════════════════════════════════╗';
PRINT '║  RBAC FIX — ARQUITECTURA CORREGIDA (10 TAREAS)                ║';
PRINT '╚════════════════════════════════════════════════════════════════╝';
GO
...
SELECT COUNT(*) AS debe_ser_cero FROM Seguridad_Usuarios_Sucursales;
GO
...
ELSE
BEGIN
    PRINT 'No hay FK hacia Param_Sucursales_Directorio ✓';
END;
...
-- ============================================================================
-- TAREA 3: ENRIQUECER Maestro_Sucursales
-- ============================================================================
PRINT '';
...
BEGIN
    ALTER TABLE Maestro_Sucursales
    ADD ciudad       NVARCHAR(100) NULL,
        estado       NVARCHAR(100) NULL,
        es_comercial BIT           NOT NULL DEFAULT 1,
        alias_excel  NVARCHAR(150) NULL;
    PRINT 'Columnas agregadas a Maestro_Sucursales ✓';
END
ELSE
BEGIN
    PRINT 'Columnas ya existen en Maestro_Sucursales ✓';
END;

-- Actualizar 26 sucursales comerciales reales
...
-- SUPERVISOR TEST → rol SUPERVISOR (id=4)
INSERT INTO Seguridad_Usuarios_Roles (id_usuario, id_rol, fecha_asignacion, esta_vigente)
...
-- LAGO MALL (id=13) tiene datos reales
...
PRINT '';
PRINT '╔════════════════════════════════════════════════════════════════╗';
PRINT '║  ✓ RBAC FIX COMPLETADO EXITOSAMENTE                           ║';
PRINT '╚════════════════════════════════════════════════════════════════╝';
